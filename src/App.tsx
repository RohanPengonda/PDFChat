...
export default function App() {
  ...
  const docItem = isDark
    ? "hover:bg-[#2a2d3e] text-gray-300"
    : "hover:bg-gray-100 text-gray-700";
  const docSelected = isDark
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-5 pt-6 pb-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className={clsx("font-bold text-lg tracking-tight", text)}>
            ChatPDF Q&A
          </span>
        </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-4 space-y-6">
        ...
        <div>
          ...
          >
            ...
            <select
              ...
              className={clsx(
                "flex-1 bg-transparent text-sm font-medium outline-none cursor-pointer",
                text,
              )}
            >
        ...
        <div>
          ...
          <p className={clsx("text-[11px] text-center mt-2", subtext)}>
            PDFs under 50MB
          </p>
        </div>
        ...
        <div>
          ...
          {documents.length === 0 ? (
            <p className={clsx("text-xs italic text-center py-3", subtext)}>
              No documents yet
            </p>
          ) : (
  ...
  return (
    <div className={clsx("flex h-screen overflow-hidden font-sans", bg)}>
      ...
      <div
        className={clsx(
          "hidden lg:flex flex-col w-[300px] flex-shrink-0 border-r",
          panel,
          border,
        )}
      >
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className={clsx("font-bold text-sm", text)}>
                ChatPDF Q&A
              </span>
            </div>
          </div>
        ...
        <div className="hidden md:flex lg:hidden flex-1 overflow-hidden">
          ...
          <div
            className={clsx(
              "w-[340px] flex-shrink-0 border-l flex flex-col",
              panel,
              border,
            )}
          >
        ...
        <div className="flex md:hidden flex-1 flex-col overflow-hidden">
          ...
          <div
            className={clsx(
              "flex-shrink-0 border-t flex items-center",
              panel,
              border,
            )}
          >
            {(
              ...
              <button
                ...
                className={clsx(
                  ...
                  mobileTab === tab ? "text-blue-400" : subtext,
                )}
              >
        ...
        <div className="hidden lg:flex flex-1 overflow-hidden">
          ...
          <div
            className={clsx(
              "w-[380px] flex-shrink-0 border-l flex flex-col",
              panel,
              border,
            )}
          >
